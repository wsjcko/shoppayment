...
import (
	...
	"github.com/wsjcko/shoppayment/handler"
...
func main() {
	...
	//zapLogger
	logger.Init("ShopPayment", "micro.log")
	...
	paymentService := service.NewPaymentService(repository.NewPaymentRepository(db))

	// Register Handler
	pb.RegisterShopPaymentHandler(srv.Server(), &handler.ShopPayment{PaymentService: paymentService})
